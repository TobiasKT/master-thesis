...
public class SensorService extends Service implements SensorEventListener {
    ...
    private final static int ACCELEROMETER_SENSOR = TYPE_ACCELEROMETER; //1
    private final static int STEP_COUNTER_SENSOR = TYPE_STEP_COUNTER; //19
    ...
    private final static int SIGNIFICANT_MOTION_SENSOR = TYPE_SIGNIFICANT_MOTION; //17
    ...
    private final static int GRAVITY_SENSOR = TYPE_GRAVITY; //9
    private final static int LINEAR_ACCELERATION_SENSOR = TYPE_LINEAR_ACCELERATION; //10

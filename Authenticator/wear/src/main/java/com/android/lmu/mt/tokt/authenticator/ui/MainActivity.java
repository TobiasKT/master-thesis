...
import com.android.lmu.mt.tokt.authenticator.keydetection.KeypressDetectorTask;
...
public class MainActivity extends WearableActivity {
    ...
    private RelativeLayout mTypingContainerRL;
    private RelativeLayout mCuesContainerRL;
    ...
    private KeypressDetectorTask mKeyPressDetectorTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCuesContainerRL = (RelativeLayout) findViewById(R.id.cues_relative);
        mTypingContainerRL = (RelativeLayout) findViewById(R.id.typing_relative);
        ...
        mBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (intent.getAction().equals(AppConstants.MESSAGE_RECEIVER_START_TYPING_DETECTION_RESULT)) {
                ...
                if (intent.getAction().equals(AppConstants.MESSAGE_RECEIVER_STOP_TYPING_DETECTION_RESULT)) {
                    Log.d(TAG, "Stop typing detection result received");
    ...
    protected void onStart() {
        ...
        filter.addAction(AppConstants.MESSAGE_RECEIVER_START_TYPING_DETECTION_RESULT);
        filter.addAction(AppConstants.MESSAGE_RECEIVER_STOP_TYPING_DETECTION_RESULT);
